...
- [Sentinel AI](https://github.com/MaxwellCalkin/sentinel-ai): real-time safety guardrails for LLM apps — prompt injection detection (12 languages), PII detection, harmful content filtering, toxicity scanning, and tool-use safety. Sub-millisecond latency with a 530-case benchmark at 100% accuracy. ![GitHub Repo stars](https://img.shields.io/github/stars/MaxwellCalkin/sentinel-ai?style=social)

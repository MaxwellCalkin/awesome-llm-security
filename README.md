...
- [Sentinel AI](https://github.com/MaxwellCalkin/sentinel-ai): zero-dependency safety guardrails for LLM apps with sub-millisecond latency ![GitHub Repo stars](https://img.shields.io/github/stars/MaxwellCalkin/sentinel-ai?style=social)
